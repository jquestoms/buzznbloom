...
if (!class_exists('BVCallbackRequest')) :
	class BVCallbackRequest {
		...
		public function verify($data, $sig, $sighshalgo) {
			...
			$filesystem = LWHelper::get_direct_filesystem();
		...
		public function authFailedResp() {
			...
			$default_secret = LWRecover::getDefaultSecret($this->settings);
			...
			$resp = array(
				...
				"def_key_status" => LWRecover::getSecretStatus($this->settings),
