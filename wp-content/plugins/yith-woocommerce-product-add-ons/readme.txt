...
You can report security bugs through the Patchstack Vulnerability Disclosure Program. The Patchstack team help validate, triage and handle any security vulnerabilities. [Report a security vulnerability.](https://patchstack.com/database/vdp/yith-woocommerce-product-add-ons)
...
== Changelog ==
= 4.20.0 – Released on 16 April 2025 =

* New: support for WordPress 6.8
* Update: YITH plugin framework

= 4.19.0 – Released on 26 March 2025 =

* New: support for WooCommerce 9.7
* Update: YITH plugin framework

= 4.18.0 – Released on 24 February 2025 =

* New: support for WooCommerce 9.7
* Update: YITH plugin framework

= 4.17.0 – Released on 29 January 2025 =

* New: support for WooCommerce 9.6
* Update: YITH plugin framework

= 4.16.1 – Released on 11 December 2024 =
...
* Update: YITH plugin framework
* Fix: Float option price && option sale price

= 4.14.1 – Released on 12 September 2024 =

* Fix: sale price calculation in cart/checkout pages

= 4.14.0 – Released on 11 September 2024 =

* New: support for WooCommerce 9.3
* Update: YITH plugin framework
* Dev: new filter 'yith_wapo_apply_urldecode'

= 4.13.1 – Released on 02 September 2024 =

* Fix: add-on image on selected by default option of Selectors
* Fix: Cross Site Scripting (XSS) vulnerability

= 4.13.0 – Released on 07 August 2024 =

* New: support for WooCommerce 9.2
* Update: YITH plugin framework
* Fix: addon image not available
* Dev: new action 'yith_wapo_after_add_order_item_meta'
