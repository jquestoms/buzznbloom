...
if (!class_exists('Basilico_Breadcrumb')) {
    class Basilico_Breadcrumb
    {
        /**
        ...
        function __construct( $args = array() )
        {
            ...
            if($page_on_front) {
                ...
                $home_label = esc_html__( 'Home', 'basilico' );
            }
            $args = wp_parse_args( $args, array(
                'home_label'            => $home_label,
                '404_label'             => esc_html__( 'Not Found', 'basilico' ),
                'search_results_label'  => esc_html__( 'Search Results', 'basilico' ),
        ...
        function add_author_entry()
        {
            ...
            $this->add_entry(
                esc_html__( 'Author:', 'basilico' ).' '.$userdata->display_name
            );
        }
