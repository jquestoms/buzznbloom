...
if (!class_exists('Basilico_Main')) {
    class Basilico_Main extends Basilico_Base
    {
        ...
        public static function getInstance()
        {
            ...
            if (null === self::$instance) {
                self::$instance = new Basilico_Main();
            }
...
function basilico() {
    return Basilico_Main::getInstance();
}
// Install
basilico();
