    ...
    <div class="pxl-swiper-slider pxl-team pxl-team-carousel layout-<?php echo esc_attr($settings['layout'])?>">
        <div class="pxl-swiper-slider-wrap pxl-carousel-inner relative">
            ...
            <div class="pxl-swiper-arrows style-arrow-chef nav-vertical-out">
                <div class="pxl-swiper-arrow pxl-swiper-arrow-prev"><span class="pxli-down-arrow-long"></span><span class="arrow-text">previours</span></div>
                <div class="pxl-swiper-arrow pxl-swiper-arrow-next"><span class="arrow-text">next</span><span class="pxli-down-arrow-long"></span></div>
            </div>
